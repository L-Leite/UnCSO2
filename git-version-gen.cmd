...
rem // This file was modified for use in the program UnCSO2

setlocal ENABLEDELAYEDEXPANSION
setlocal ENABLEEXTENSIONS

set GIT_VERSION_FILE=%~p0.\src\gitversion.h
if not defined GIT (
	set GIT="git"
)
call %GIT% describe --all > NUL 2> NUL
if errorlevel 1 (
...
if exist "%GIT_VERSION_FILE%" (
	...
	findstr /B /C:"#define GIT_VERSION_NO_UPDATE 1" "%GIT_VERSION_FILE%" > NUL
	if not errorlevel 1 (
		goto done
	)
)
...
if errorlevel 1 (
	...
	echo #define GIT_VERSION "unknown" >> "%GIT_VERSION_FILE%"
	echo #define GIT_BRANCH "unknown" >> "%GIT_VERSION_FILE%"
	echo. >> "%GIT_VERSION_FILE%"
	echo // If you don't want this file to update/recompile, change to 1. >> "%GIT_VERSION_FILE%"
	echo #define GIT_VERSION_NO_UPDATE 0 >> "%GIT_VERSION_FILE%"
	goto done
)
...
echo // This is a generated file. > "%GIT_VERSION_FILE%"
echo. >> "%GIT_VERSION_FILE%"
echo #define GIT_VERSION "%GIT_VERSION%" >> "%GIT_VERSION_FILE%"
echo #define GIT_BRANCH ^"%GIT_BRANCH%^" >> "%GIT_VERSION_FILE%"
echo. >> "%GIT_VERSION_FILE%"
echo // If you don't want this file to update/recompile, change to 1. >> "%GIT_VERSION_FILE%"
echo #define GIT_VERSION_NO_UPDATE 0 >> "%GIT_VERSION_FILE%"
